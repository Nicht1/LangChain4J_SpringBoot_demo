...
public class EasyRAGChatController {
    ...
    public Map<String, Object> sendMessage(@RequestBody MessageRequestVO messageRequestVO) {
        ...
        MessageResponseVO messageResponseVO = easyRAGChatService.sendMessage(messageRequestVO.getSessionId(),
...
//
//
//        MessageResponseVO messageResponseVO = easyRAGChatService.sendMessageByUserChat(messageRequestVO.getSessionId(),
//                messageRequestVO.getUserId(),
//                messageRequestVO.getMessage());
//
//        result.put("success", true);
